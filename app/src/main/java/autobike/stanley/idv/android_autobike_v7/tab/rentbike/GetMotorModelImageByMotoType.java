...
public class GetMotorModelImageByMotoType extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "getImageByMotoType";
    private final static String ACTION = "getImageByMotoType";
    private final WeakReference<ImageView> imageViewWeakReference;

    public GetMotorModelImageByMotoType(ImageView imageView) {
    ...
    protected Bitmap doInBackground(Object... params) {
        ...
        String mototype = params[1].toString();
        int imageSize = Integer.parseInt(params[2].toString());
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("action", ACTION);
        jsonObject.addProperty("mototype", mototype);
