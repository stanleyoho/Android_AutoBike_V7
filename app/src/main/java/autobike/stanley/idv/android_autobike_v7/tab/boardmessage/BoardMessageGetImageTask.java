...
public class BoardMessageGetImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "BoardMesGetImageTask";
    private final static String ACTION = "getImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    BoardMessageGetImageTask(ImageView imageView) {
    ...
    protected Bitmap doInBackground(Object... params) {
        ...
        String mesno = params[1].toString();
        int imageSize = Integer.parseInt(params[2].toString());
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("action", ACTION);
        jsonObject.addProperty("mesno", mesno);
