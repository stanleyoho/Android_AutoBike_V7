...
public class MotorGetAllWithBrandTask extends AsyncTask<Object, Integer, List<Motor>> {
    private final static String TAG = "GetAllWithBrandTask";
    private final static String ACTION = "getAllWithBrand";

    @Override
    protected List<Motor> doInBackground(Object... params) {
        String url = params[0].toString();
        String brand = params[1].toString();
        String jsonIn;
