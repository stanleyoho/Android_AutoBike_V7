...
public class SellBikeGetAllTask extends AsyncTask<Object, Integer, List<Motor>> {
    private final static String TAG = "SellBikeGetAllTask";
    private final static String ACTION = "getSellBikeAll";
