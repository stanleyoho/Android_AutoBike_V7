...
public class GetNewsImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "NewssGetImageTask";
    private final static String ACTION = "getImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    GetNewsImageTask(ImageView imageView) {
    ...
    protected Bitmap doInBackground(Object... params) {
        ...
        String newsno = params[1].toString();
        int imageSize = Integer.parseInt(params[2].toString());
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("action", ACTION);
        jsonObject.addProperty("newsno", newsno);
